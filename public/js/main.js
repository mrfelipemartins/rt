        ...
        googleMap: function() {
            if ( $().gmap3 ) {
                var contentString = '<div id="content">'+
                    ...
                    '<h3 style="text-align:center;">RT Multi Serv</h3>'+
                    '<p style="text-align:center;">Empresa Industrial - Rua Manoel Torres 1233 Santa Tereza, 27175000 Piraí' +
                    '</p>'+
                    '</div>';
                $('#gmap')
                .gmap3({
                    center: [-22.62227, -43.911531],
                    zoom: 14,
                    scrollwheel: false
                })
                .infowindow({
                    position: [-22.62227, -43.911531],
